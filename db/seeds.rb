...
order_list = [
    ...
    [10377, '2005-02-09', '2005-02-21', '2005-02-12', 'Shipped', 'Cautious optimism. We have happy customers here, if we can keep them well stocked.  I need all the information I can get on the planned shipments of Porches', 186],
...
customer_list.each do |customerNumber, customerName, contactLastName, contactFirstName, phone, addressLine1, addressLine2, city, state, zipCode, country|
...
order_list.each do |orderNumber, orderDate, requiredDate, shippedDate, status, comments, customerNumber|
  Order.create(orderNumber: orderNumber, orderDate: orderDate, requiredDate: requiredDate, shippedDate: shippedDate, status: status, comments: comments, customerNumber: customerNumber)
end

product_lines_list.each do |productLine, textDescription, htmlDescription, image|
  ProductLine.create(productLine: productLine, textDescription: textDescription, htmlDescription: htmlDescription, image: image)
end

product_list.each do |productCode, productName, productLine, productScale, productVendor, productDescription, quantityInStock, buyPrice, msrp|
  Product.create(productCode: productCode, productName: productName, productLine: productLine, productScale: productScale, productVendor: productVendor, productDescription: productDescription, quantityInStock: quantityInStock, buyPrice: buyPrice, MSRP: msrp)
end
